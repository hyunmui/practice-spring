package com.flexibledev.java.aspect;
...
public class LoggingAspect {
	...
	// getLogging 포인트컷
	@Pointcut("execution(* com.flexibledev.java.*.*.get*(..))" + " || execution(* com.flexibledev.java.*.*.find*(..))")
	public void getLogging() {
	}

	// 매개변수 포인트 컷
	@Pointcut("execution(* com.flexibledev.java.service.*.update*(com.flexibledev.java.domain.Customer))" + " && args(customer)")
	...
	// around 어드바이스
	@Around("execution(* com.flexibledev.java.*.*.save*(..))")
